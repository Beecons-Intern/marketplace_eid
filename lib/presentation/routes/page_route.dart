...
import 'package:marketplace/presentation/screens/lokasi_alamat_screen/alamat_screen.dart';
import 'package:marketplace/presentation/screens/lokasi_alamat_screen/components/ubah_alamat.dart';
import 'package:marketplace/presentation/screens/lokasi_alamat_screen/lokasi_screen.dart';
...
import 'package:marketplace/presentation/screens/tracking_order_screen/components/detail_tracking.dart';
import 'package:marketplace/presentation/screens/tracking_order_screen/components/tracking.dart';
import 'package:marketplace/presentation/screens/tracking_order_screen/detail_transaksi.dart';
...
class AppPage {
  static final pages = {
    ...
    RouteName.ubahAlamat: (context) => const UbahAlamatScreen(),
    RouteName.lokasi: (context) => const LokasiScreen(),
    RouteName.alamat: (context) => const AlamatScreen(),
    RouteName.lihatTracking: (context) => LihatTrackingScreen(),
    RouteName.detailResi: (context) => const DetailTracking(),
    RouteName.detailTransaksi: (context) => const TrackingScreen(),
    RouteName.favorite: (context) => const FavoriteScreen(),
  };
}
